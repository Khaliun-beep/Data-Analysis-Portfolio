...
### *3. E-commerce Customer Behavior Analysis with SQL* <a href="https://github.com/Khaliun-beep/Projects/blob/main/Ecommerce_Customer_behavior.sql" target="_blank" style="display: inline-block; padding: 8px 16px; font-size: 14px; color: #fff; background-color: #007bff; text-align: center; text-decoration: none; border-radius: 4px;">Click Here</a>
...
*Dashboard 1:* [City-Wise Customer Ratings and Discount Impact] <a href="https://github.com/Khaliun-beep/Projects/blob/main/Dashboard%202.png" target="_blank" style="display: inline-block; padding: 8px 16px; font-size: 14px; color: #fff; background-color: #007bff; text-align: center; text-decoration: none; border-radius: 4px;">Click Here</a>
...
*Dashboard 2:* [Customer Segmentation and Loyalty Analysis] <a href="https://github.com/Khaliun-beep/Projects/blob/main/Dashboard%201%20(1).png" target="_blank" style="display: inline-block; padding: 8px 16px; font-size: 14px; color: #fff; background-color: #007bff; text-align: center; text-decoration: none; border-radius: 4px;">Click Here</a>
